...
@section('title', 'Volta App – Mesaje din app – VOLTA')
...
<div class="ma-page">
  ...
  <section class="ma-hero">
    <div class="ma-hero__row">
      <div>
        ...
        <h1 class="ma-hero__title">Mesaje din aplicație</h1>
  ...
  <div class="ma-kpis">
    ...
    <div class="ma-kpi ma-kpi--accent">
      <span class="ma-kpi__label"><i class="fas fa-image" aria-hidden="true"></i> Cu captură ecran</span>
    ...
    <div class="ma-kpi">
      ...
      <span class="ma-kpi__help">Persoane care au scris</span>
    </div>
  </div>

  <section class="ma-card">
    <div class="ma-card__head">
      <h2><i class="fas fa-inbox" aria-hidden="true"></i> Mesaje primite</h2>
