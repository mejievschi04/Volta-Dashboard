...
@section('title', 'Volta App – Ultimele acțiuni – VOLTA')
...
<div class="ma-page">
  ...
  <section class="ma-hero">
    <div class="ma-hero__row">
      <div>
        ...
        <h1 class="ma-hero__title">Ultimele acțiuni</h1>
        <p class="ma-hero__lead">Lista cronologică a tot ce s-a întâmplat în aplicație.</p>
      </div>
  ...
  <section class="ma-card">
    <div class="ma-card__head">
      <h2><i class="fas fa-clock-rotate-left" aria-hidden="true"></i> Istoric</h2>
      @if($schemaReady && $recentEvents)
        <span class="ma-muted">{{ number_format($recentEvents->total(), 0, ',', '.') }} acțiuni</span>
      @endif
    </div>
    <div class="ma-card__body ma-table-wrap">
      <table class="ma-table">
        <thead><tr><th>Ora</th><th>Acțiune</th><th>Pagină</th><th>Utilizator</th><th>Vizită</th><th>Detalii</th></tr></thead>
        <tbody>
